...
class InternVL3Embedder(nn.Module):
    def __init__(self, model_name="OpenGVLab/InternVL3-1B", image_size=448, device="cuda",fusion_block=None):
        super().__init__()
        self.device = device
        ...
        if self.fusion_block is not None:
            print(f"✅ InternVL3Embedder: Using external fusion block")
            print(f"   Fusion block type: {type(self.fusion_block).__name__}")
